            ...
            <div class="card card-info">
              ...
              <form role="form">
                ...
                <div class="row">
                  <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Introduzca su numero de DUI">
                      </div>
                    </div>
                    <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="row">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Introduzca su Correo Electronico">
                  </div>
                </div>
                  ...
                  <div class="col-sm-6">
                    ...
                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Introduzca su Contraseña">
                  </div>
                </div>
              </div>
                <!-- /.card-body -->
