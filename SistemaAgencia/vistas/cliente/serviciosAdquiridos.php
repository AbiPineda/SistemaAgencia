                                            ...
                                            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" id="custom-tabs-four-encomiendas-tab"
                                                        ...
                                                        role="tab" aria-controls="custom-tabs-four-encomiendas"
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" id="custom-tabs-four-vehiculos-tab"
                                                        data-toggle="pill" href="#custom-tabs-four-vehiculos" role="tab"
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" id="custom-tabs-four-cotizarvehiculos-tab"
                                                        data-toggle="pill" href="#custom-tabs-four-cotizarvehiculos"
                                                        role="tab" aria-controls="custom-tabs-four-cotizarvehiculos"
                                                        aria-selected="false">Cotizaciones Vehículos</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="custom-tabs-four-cotizarvuelos-tab"
                                                        data-toggle="pill" href="#custom-tabs-four-cotizarvuelos"
                                                        role="tab" aria-controls="custom-tabs-four-cotizarvuelos"
                                        ...
                                        <div class="card-body">
                                            <div class="tab-content" id="custom-tabs-four-tabContent">
                                                <div class="tab-pane fade show active" id="custom-tabs-four-home"
                                                    ...
                                                    abi ipsum dolor sit amet, consectetur adipiscing elit. Proin
                                                    ...
                                                    magna, mollis auctor felis vitae, ullamcorper ornare ligula.
                                                    ...
                                                    pulvinar
                                                    non consequat neque. Mauris lacus elit, condimentum ac condimentum
                                                    at, semper vitae lectus. Cras lacinia erat eget sapien porta
                                                    consectetur.
                                                </div>
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-four-vehiculos"
                                                    role="tabpanel" aria-labelledby="custom-tabs-four-vehiculos-tab">
                                                    <div class="col-sm-12">
                                                        <table id="add-vehiculos"
                                                            class="table table-bordered table-hover">
                                                            <thead>
                                                                <tr style="text-align: center;">
                                                                    <th>ID Detalle</th>
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-four-cotizarvehiculos"
                                                    role="tabpanel"
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-four-cotizarvuelos"
                                                    role="tabpanel"
