...
<div class="content-wrapper">
    ...
    <section class="content" style="margin-top: 7px;">
        ...
        <div class="modal fade" id="registro-actualizacion" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    ...
                    <form id="register-form" name="register-form" onsubmit="return false" role="form">
                                ...
                                <div class="col-lg-9">
                                    <div class="form-group">
                                        <form id="task-form">
                                            <div class="form-group">
                                                <label>Cliente</label>
                                                <input type="hidden" name="id_encomienda" id="id_encomienda"
                                                    class="form-control">
                                                <input type="text" name="cliente" id="cliente" placeholder="Encomienda"
                                                    class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label>Fecha</label>
                                                <input type="date" id="fecha" placeholder="Encomienda"
                                                    class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label>Lugar</label>
                                                ...
                                                <span class="input-group-btn">
                                                    <button type="button" class="btn btn-success btn-add"
                                                        name="btn-mapa"
                                                        style="margin-top:-38px; width: 11%; height: 37px; margin-left:308px;"
                                                        id="btn-mapa">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="descripcion" cols="10" rows="3" class="form-control"
                        ...
                        <div class="modal-footer">
                            <button type="button" id="btnEnvio" class="btn btn-primary btn-sm"
