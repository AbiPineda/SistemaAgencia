            ...
            <div class="timeline">
              ...
              <div>
                ...
                <div class="timeline-item">
                  <h3 class="timeline-header"><a href="#">Datos
                      Generales</a></h3>
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="form-group multiple-form-group input-group">
                          ...
                          <div class="input-group">
                            <select name="ComboTur" id="ComboTur" class="select2 select2-hidden-accessible form-control"
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-5 text-center">
                                      <img id="imgContactoTur"
                                        src="http://www.lagraderia.com/wp-content/uploads/2018/12/no-imagen.jpg" alt=""
                                        class="img-fluid">
                                    </div>
                                  </div>
                                </div>
