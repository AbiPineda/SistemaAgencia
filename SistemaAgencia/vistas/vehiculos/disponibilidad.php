...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Disponibilidad de Vehiculos</h1>
                </div>
                <div class="col-sm-6">
              ...
              <div class="card-body">
                <div>
                  <div class="btn-group w-100 mb-2">
                    ...
                    <a class="btn btn-info" href="javascript:void(0)" data-filter="3"> Pickup </a>
                    <a class="btn btn-info" href="javascript:void(0)" data-filter="4"> Microbuses</a>
                  </div>
                  <div class="mb-2">
