                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input id="tipoCombustible" name="tipoCombustible" type="text" class="form-control"
                                 disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input id="precio_diario" name="precio_diario" type="number" value="" maxlength="9"
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                           <label># Puertas</label>
                           <div class="input-group">
                              <input id="puertas" name="puertas" type="number" min=1 max=4 class="form-control"
                                 disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input id="pasajeros" name="pasajeros" type="number" min=1 max=60 class="form-control"
                                 disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input id="kilometraje" name="kilometraje" type="number" min=1 class="form-control"
                                 disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
