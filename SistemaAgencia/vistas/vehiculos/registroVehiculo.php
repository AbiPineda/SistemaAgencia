                        ...
                        <div class="timeline-body">
                           <div class="row">
                              ...
                              <div class="col-sm-3">
                                 ...
                                 <div class="form-group">
                                    <label>Placa</label>
                                    <input type="text" class="form-control" placeholder="Introduzca placa" name="placa"
                                       id="placa" autocomplete="off">
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <!-- select -->
                              ...
                              <div class="col-sm-3">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" min=10 name="kilometraje" id="kilometraje"
                                       autocomplete="off">
                                 </div>
                              </div>
                              <div class="col-sm-2">
                              ...
                              <div class="col-sm-2">
                                 <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" min=1 max=60 name="pasajero" id="pasajero"
                                       autocomplete="off">
                                 </div>
                              </div>
                              <div class="col-sm-2">
