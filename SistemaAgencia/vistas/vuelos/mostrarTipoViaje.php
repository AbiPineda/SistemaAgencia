                    ...
                    <div class="card-header">
                        ...
                        <div class="timeline-footer" style="text-align: right;">
                            <a class="btn btn-info btn-sm" style="color: white" data-toggle="modal"
                                data-target="#modal-clase">Nuevo Tipo de Viaje</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                    ...
                                    <table id="tabla_vehiculos1"
                                        ...
                                        <tbody>
                                            <tr role="row" class="odd" style="text-align: left;">
                                                <td tabindex="0" class="sorting_1">Cultural</td>
                                                <td tabindex="0" class="sorting_1">
                                                    Es uno de los tipos de turismo más conocidos y practicados en la
                                                    actualidad, cuando la gente se preocupa por conocer la historia y la
                                                    cultura de otras ciudades, que normalmente viven diferente: el
                                                    idioma, las costumbres, los lugares, los horarios, la gastronomía,
                                                    los monumentos.
                                                    <br>
                                                    Aunque pueda parecer similar, todo es diferente y
                                                    esto atrae a una masa ingente de turistas que quieren conocer cosas
                                                    nuevas.
                            ...
                            <div class="timeline">
                                ...
                                <div>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <h3 class="timeline-header"><a href="#">Registrar Tipo de Viaje</a> </h3>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Digite tipo de viaje">
                                                    </div>
