       <!-- Start Footer bottom Area -->
        ...
        <script src="<?=$base_url?>lib/knob/jquery.knob.js"></script>
        <script src="<?=$base_url?>lib/wow/wow.min.js"></script>
        <script src="<?=$base_url?>lib/parallax/parallax.js"></script>
        <script src="<?=$base_url?>lib/easing/easing.min.js"></script>
        <script src="<?=$base_url?>lib/nivo-slider/js/jquery.nivo.slider.js" type="text/javascript"></script>
        <script src="<?=$base_url?>lib/appear/jquery.appear.js"></script>
