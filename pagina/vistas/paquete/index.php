                ...
                <div class="slider-content text-center">
                    <div class="header-bottom">
                        <div class="layer2 wow zoomIn" data-wow-duration="1s" data-wow-delay=".4s">
                            <h1 class="title2">Los Mejores Paquetes turisticos</h1>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 fondo-blanco">
                <div class="section-title">
                    <h3 class="title">Nuestros Paquetes</h3>
                            ...
                            <div class="products-slick" data-nav="#slick-nav-1">
                                ...
                                <div class="product">
                                    ...
                                    <div class="add-to-cart">
                                        <button class="add-to-cart-btn"  onclick="location.href = 'detalle-paquete.php'"  >
                                ...
                                <div class="product">
                                    ...
                                    <div class="add-to-cart">
                                        <button class="add-to-cart-btn"  onclick="location.href = 'detalle-paquete.php'"><i
